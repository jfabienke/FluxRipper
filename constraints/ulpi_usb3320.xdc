...
##-----------------------------------------------------------------------------
## ULPI USB3320 PHY Interface Constraints
...
##
## Description:
##   Constraints for USB3320 ULPI (UTMI+ Low Pin Interface) PHY
...
# ULPI 60 MHz clock from USB3320 PHY
...
# USB3320 spec: Valid data window is typically 5ns setup, 1ns hold relative to ulpi_clk
...
# USB3320 operates at 3.3V LVCMOS
...
# USB3320 requires valid data within one clock cycle
